...
public class LoginControllerTest {
    ...
    public void postLogin_withoutUserCredentials_receiveBadRequest() throws Exception{
        mvc
                .perform(MockMvcRequestBuilders.post("/api/1.0/auth").contentType(MediaType.APPLICATION_JSON))
    ...
    public void postLoginUser_withValidCredentials_receiveOk() throws Exception{
        ...
        mvc
                .perform(MockMvcRequestBuilders.post("/api/1.0/auth").content(TestUtil.createValidUserCreds()).contentType(MediaType.APPLICATION_JSON))
    ...
    public void postLoginUser_withIncorrectCredentials_receiveUnauthorized() throws Exception{
        mvc
                .perform(MockMvcRequestBuilders.post("/api/1.0/auth").content(TestUtil.createInValidUserCreds()).contentType(MediaType.APPLICATION_JSON))
